    ...
    <ProjectStack direction="column" spacing={2}>
      <ProjectStack direction="row" spacing={4}>
        <ProjectCard
          ...
          demoImage={
            "https://user-images.githubusercontent.com/55030581/215596284-6a93e9f8-0453-4dbd-bcdf-3cfe1ae5c11b.gif"
          }
        ...
        <ProjectCard
          ...
          demoImage={
            "https://em-content.zobj.net/socialmedia/apple/48/robot-face_1f916.png"
          }
      ...
      <ProjectStack direction="row" spacing={4}>
        <ProjectCard
          ...
          demoImage={
            "https://raw.githubusercontent.com/cmanage1/shelf-it/master/__tests__/case_6.gif"
          }
        ...
        <ProjectCard
          ...
          subheader="Full Stack Development"
          demoImage={
            "https://raw.githubusercontent.com/cmanage1/lm-genie/master/test_gifs/demo.gif"
          }
